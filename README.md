...
\* \*\*Backend Utilities:\*\* Python 3 core scripting (`plant\_functions.py`)

\* \*\*Data Layer:\*\* Flat-file `.csv` architecture (`plants\_collection.csv` and `care\_history.csv`) for persistent local storage using Pandas
...
├── plant\_functions.py      # Core data models, calculation engines, and CSV automation

├── plants\_collection.csv   # Automatically generated database for plant attributes

├── care\_history.csv        # Automatically generated ledger tracking historic actions
